...
### ⌛ 구현 기간 : 2023.11.12 ~ 2023.11.15
- 2023.11.12 : 기능 목록 작성
- 2023.11.12 ~ 2023.11.14 : 기능 구현
- 2023.11.15 : 기능 리팩토링, 테스트 코드 작성
...
- ### TEST CASE 
  ...
  - 총 혜택 금액에 따라 이벤트 배지 부여되는지
    - 5천원 이상 - 별 : 이벤트_배지_별_출력() ✔️
    - 1만원 이상 - 트리 : 이벤트_배지_트리_출력() ✔️
    - 2만원 이상 - 산타 : 이벤트_배지_산타_출력() ✔️
  - 모든 타이틀 출력되는지
    - 모든_타이틀_출력() ✔️
